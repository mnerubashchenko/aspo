...
Type_interface UNIQUEIDENTIFIER FOREIGN KEY REFERENCES TYPEINTER(ID),
IpInput_interface VARCHAR (30),
ActualIp_interface VARCHAR (30));

CREATE TABLE DEVICES
(ID UNIQUEIDENTIFIER PRIMARY KEY DEFAULT newsequentialid(),
Brand_device UNIQUEIDENTIFIER FOREIGN KEY REFERENCES BRANDS(ID),
Model_device VARCHAR (30),
Status_device VARCHAR (30),
IpInput_device VARCHAR (30),
ActualIp_device VARCHAR (30),
Port_device VARCHAR (30),
Type_device UNIQUEIDENTIFIER FOREIGN KEY REFERENCES TYPEDEV(ID),
Caption_device VARCHAR(100));

INSERT INTO DEVICES(ID, Model_device) VALUES ('00000000-0000-0000-0000-000000000000', '---');
...
Type_measure UNIQUEIDENTIFIER FOREIGN KEY REFERENCES TYPEMEASURE(ID),
