...
INSERT INTO ROLES (Name_role) VALUES ('Администратор');
...
INSERT INTO USERS (Login_user, Password_user) VALUES ('admin', 'kavOk72+FgAcqkWq0Mosqw==CABgMHN0asS1KfpQ5RHdUGZ7eCF6lFawC9nWJt9sWWY=');
...
Protocol_comment UNIQUEIDENTIFIER FOREIGN KEY REFERENCES PROTOCOL(ID_protocol),
