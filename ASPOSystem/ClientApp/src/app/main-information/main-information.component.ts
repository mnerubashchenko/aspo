...
export class MainInformationComponent implements OnInit {
    ...
    maininfo: string[] = ["Проекты", "Протоколы", "Проекты-Измерения", "Интерфейсы", "Устройства", "Измерения", "Устройства-Измерения", "Протоколы-Измерения", "Протоколы-Телеметрия", "Протоколы-Программные команды"];
    tablename: string;
